...
export var SCMachine = function (_a) {
    var machineSrc = _a.machine;
    var machine = toMachine(machineSrc);
    var _b = useState({
        machine: machine,
        current: machine.initialState,
        service: interpret(machine)
    }), service = _b[0].service, setState = _b[1];
    return (React.createElement(StyledStateChart
    // className={this.props.className}
    , { 
        // className={this.props.className}
        key: machine.id, style: {
        ...
        React.createElement(StateChartContainer, { service: service, onReset: function () { return void 0; } })));
};
